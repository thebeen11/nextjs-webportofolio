            ...
            <div className="flex items-center sm:mx-10 md:mx-20 justify-between w-full">
              ...
              <div className="flex  justify-center items-center flex-shrink-0 ml-10">
                <h1 className="font-bold text-xl cursor-pointer">
                  Im<span className="text-blue-500">been</span>
                </h1>
              </div>
            ...
            <div className="md:hidden" id="mobile-menu">
              ...
              >
                <Link
                  ...
                  offset={50}
                  duration={500}
                  className="cursor-pointer text-black hover:bg-blue-600 hover:text-white block rounded-md px-3 py-2 text-base font-medium"
                >
                  Home
                </Link>
                <Link
